...
SCATTERMOE_CONVERSION_SPEC = {
    "MixtralForCausalLM": ('gate', 'experts', SCATTERMOE_HAS_GATE_WEIGHT_SPEC),
    'GraniteMoeForCausalLM': ('router', 'input_linear|output_linear|input_linear', SCATTERMOE_HAS_GATE_WEIGHT_SPEC)
}